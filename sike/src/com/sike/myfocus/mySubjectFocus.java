...
public class mySubjectFocus extends Activity {

	private ListView listView;  
    private ListViewSubAdapter adapter;  
              ...
              switch (msg.what) {  
  	            case UPDATE_TEXT:  
  	                ...
  	                try {
  	        			...
  	        			JSONArray jsonList = demoJson.getJSONArray("subList");
  	        			if(jsonList.length() == 0) {
  		        			...
  		        			listView = (ListView) findViewById(R.id.myFocus_listview);
  	  	        			adapter = new ListViewSubAdapter(mySubjectFocus.this, beans);
    ...
    private String[] getData() {
	    ...
	    new Thread(new Runnable(){
	    	...
	    	public void run() {
	            ...
	            .url("http://itdodo.top/api2/subject/list")
	            .build();
		   		 try {
